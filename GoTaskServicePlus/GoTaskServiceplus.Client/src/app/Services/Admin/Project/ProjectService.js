...
var ProjectService = function () {
    ...
    var ProjectService = _classThis = /** @class */ (function () {
        function ProjectService_1(http, host) {
            this.http = http;
            this.host = host;
        ...
        ProjectService_1.prototype.Saved = function (project) {
        ...
        ProjectService_1.prototype.Upbdate = function (company) {
            var reqHeaders = new http_1.HttpHeaders().set('Content-Type', 'application/json');
            var result = this._http.post(this._host.GetHostApi() + "Project/UpdateProject", company);
            return result;
        };
        ProjectService_1.prototype.Delete = function (id) {
            var result = this._http.delete(this._host.GetHostApi() + "Project/DeleteProjectById" + "?id=" + id);
            return result;
        };
        ProjectService_1.prototype.GetAllProject = function (filter, idCompany, page) {
        ...
        ProjectService_1.prototype.GetAllProjectByCompany = function (idCompany, page) {
            var _this = this;
            if (idCompany == "")
        ...
        ProjectService_1.prototype.GetListAdress = function (filter, type, page) {
        ...
        ProjectService_1.prototype.GetAdminAllConceptByIdProject = function (filter, type, page, idProject) {
            //GetAllConcept?filter=all&type=AdressConcept&page=1
            var response = this._http.get(this._host.GetHostApi() + "Concept/GetAdminAllConceptByIdProject?filter=".concat(filter, "&type=").concat(type, "&page=").concat(page, "}&idProject=").concat(idProject));
            return response;
        };
        ProjectService_1.prototype.GetAdminAllConceptByIdCompany = function (filter, type, page, idCompany) {
            //GetAllConcept?filter=all&type=AdressConcept&page=1
            var response = this._http.get(this._host.GetHostApi() + "Concept/GetAdminAllConceptByIdCompany?filter=".concat(filter, "&type=").concat(type, "&page=").concat(page, "&idCompany=").concat(idCompany));
            return response;
        };
        ProjectService_1.prototype.GetProjectById = function (id) {
            var result = this._http.get(this._host.GetHostApi() + "Project/GetProjectById?idProject=".concat(id));
            return result;
        };
        ProjectService_1.prototype.GetAllCompanys = function (filter, page) {
        ...
        ProjectService_1.prototype.GetCoordinatesProject = function (filter, type, page) {
            var response = this._http.get(this._host.GetHostApi() + "Concept/GetAllConcept?filter=".concat(filter, "&type=").concat(type, "&page=").concat(page));
            return response;
        };
