...
var ItemProductView = function () {
    ...
    var ItemProductView = _classThis = /** @class */ (function () {
        function ItemProductView_1(_FavoriteService, _Permission, route, _language, configservice, ProductItemService, CartService, AlertBuyService, _util, _ShareService, _HtmlToImg, _HtmlToImgService, _ShareControler, _cdRef) {
        ...
        ItemProductView_1.prototype.ngOnInit = function () {
            this.Mode();
            //var r = new Language();
            //r.key = "Name";
            //r.value = "Nombre";
        ...
        ItemProductView_1.prototype.ImgError = function () {
        };
        ItemProductView_1.prototype.ShareProduct = function (product, url) {
        ...
        ItemProductView_1.prototype.Route = function (routeValue) {
        ...
        ItemProductView_1.prototype.IsFavorite = function (id) {
            if (!this._FavoriteService._favoritesList)
                return false;
        ...
        ItemProductView_1.prototype.IsBuyCart = function (id) {
        ...
        ItemProductView_1.prototype.GetAdress = function (address) {
            return address.concept.name;
        };
        ItemProductView_1.prototype.FavoriteAdd = function (product) {
            this._FavoriteService.AddProductFavorite(product);
        };
        ItemProductView_1.prototype.CartBuyAdd = function (product) {
            this._CartService.AddProductCart(product);
        };
        ItemProductView_1.prototype.OpenCartAlert = function (product) {
            this._AlertBuyService.product = product;
        };
        ItemProductView_1.prototype.FavoriteRemove = function (id) {
            this._FavoriteService.RemoveFavoriteById(id);
        };
        ItemProductView_1.prototype.CartRemove = function (product) {
            this._CartService.RemoveCartById(product.id);
        };
        ItemProductView_1.prototype.SentWhatsapp = function (idCompany) {
            this._ProductItemService._product;
            //"https://api.whatsapp.com/send?phone=573228095355&text="
        };
        ItemProductView_1.prototype.GetProjectId = function (id, product) {
        ...
        ItemProductView_1.prototype.GetTicket = function (mode) {
        ...
        ItemProductView_1.prototype.SelctProduct = function (productSelect) {
            var name = "";
        ...
        ItemProductView_1.prototype.GetUrlProduct = function (productSelect) {
            var name = "";
            productSelect.name.split(" ").forEach(function (e) {
                if (e != "")
                    name += e + (e != "" ? "-" : "");
        ...
        ItemProductView_1.prototype.GetUrlImg = function (image, scaleTo) {
        ...
        ItemProductView_1.prototype.GeNameConcepVista = function (value) {
        ...
        ItemProductView_1.prototype.GeNameConcepNumberVista = function (value) {
            if (value != null && value != undefined) {
                return value.value;
            }
            else
        ...
        ItemProductView_1.prototype.IsService = function (product) {
        ...
        ItemProductView_1.prototype.searchProduct = function (routeValue) {
            this.route.navigate([routeValue]);
        };
        ItemProductView_1.prototype.languageTraslate = function (value) {
            return value;
        };
        // Verificar si se está ejecutando en un dispositivo móvil
        ItemProductView_1.prototype.isMobileDevice = function () {
            return /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent);
        };
        ItemProductView_1.prototype.Mode = function () {
        ...
        return ItemProductView_1;
    }());
    __setFunctionName(_classThis, "ItemProductView");
    (function () {
        ...
        ItemProductView = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ItemProductView = _classThis;
}();
exports.ItemProductView = ItemProductView;
//# sourceMappingURL=app.product-item-product.js.map