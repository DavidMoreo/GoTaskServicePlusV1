...
exports.TextToSpeechComponent = void 0;
...
var TextToSpeechComponent = function () {
    ...
    var _classThis;
    var TextToSpeechComponent = _classThis = /** @class */ (function () {
        function TextToSpeechComponent_1(configservice, _file, cdRef, titleService, _utiliti, loading) {
        ...
        ;
        TextToSpeechComponent_1.prototype.ngAfterViewInit = function () {
            this.LoadDataAfterView();
        };
        TextToSpeechComponent_1.prototype.ngOnInit = function () {
            this.loadngOnInit();
        };
        TextToSpeechComponent_1.prototype.loadngOnInit = function () {
        ...
        TextToSpeechComponent_1.prototype.LoadDataAfterView = function () {
            var _this = this;
        ...
        TextToSpeechComponent_1.prototype.modeSpeechLang = function (event) {
            var _this = this;
        ...
        TextToSpeechComponent_1.prototype.onSelectChange = function (event) {
            var _this = this;
            this._listVoice.forEach(function (elemet) {
                if (elemet.name == event.target.value) {
                    _this._selectedVoice = elemet;
                    console.log(_this._selectedVoice);
                }
            });
        };
        TextToSpeechComponent_1.prototype.speech = function (value) {
            var _this = this;
            this.statusSpeech = true;
            if (value != "" && value != undefined) {
                try {
                    this.statusSpeech = false;
                    var wordsString = this.getReplace(value);
                    var words_1 = wordsString.split(/\. (?=[A-Z])|\.$|\.\n/);
                    this.texSpeech = words_1[this.countSpeech];
                    ...
                    this.pages = this.countSpeech + " de " + words_1.length;
                    item.onend = function () {
                        if (_this.countSpeech < words_1.length) {
                            console.log("ejecuto : " + words_1[_this.countSpeech] + " Conteo " + _this.countSpeech + " de " + words_1.length);
                            _this.countSpeech = _this.countSpeech + 1;
                            _this.speech(value);
                        }
                        else if (_this.countSpeech >= words_1.length) {
                            _this.countSpeech = 0;
                            console.log("Cancelada : " + words_1[_this.countSpeech] + " > " + _this.countSpeech);
                    ...
                    item.onresume = function () {
                        console.log("onresume : " + " " + " " + _this.countSpeech + " " + " " + words_1.length + "");
                    };
                    item.onerror = function () {
                        console.log("error : " + " " + " " + _this.countSpeech + " " + " " + words_1.length + "");
                    };
                    item.onboundary = function () {
                        console.log("fin : " + " " + " " + _this.countSpeech + " " + " " + words_1.length + "");
                    };
        ...
        TextToSpeechComponent_1.prototype.getReplace = function (value) {
        ...
        TextToSpeechComponent_1.prototype.speechCancel = function () {
        ...
        TextToSpeechComponent_1.prototype.speechGoPage = function (value, mode) {
            window.speechSynthesis.cancel();
            if (mode == "min")
        ...
        TextToSpeechComponent_1.prototype.onFileSelected = function (event) {
            console.log("File...");
        ...
        TextToSpeechComponent_1.prototype.extractTextFromPDF = function (fileRead) {
            var _this = this;
            this.alertSmg("Esperando...");
            this.file.ReaderFile(fileRead).subscribe({
                next: function (read) {
                    _this._visibleLoading = false;
                    _this._extractedText = read.json;
                    console.log("File...fin" + _this._extractedText);
                    _this.countSpeech = 0;
        ...
        TextToSpeechComponent_1.prototype.inputTextChanged = function () {
            this._extractedTextChanged = this._extractedText;
        };
        TextToSpeechComponent_1.prototype.loadMemory = function () {
            var _this = this;
        ...
        TextToSpeechComponent_1.prototype.getMemory = function (name) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this._utiliti.GetLocalStorage("MemoryList")];
                });
            });
        };
        TextToSpeechComponent_1.prototype.savedMemory = function (value) {
            return __awaiter(this, void 0, void 0, function () {
        ...
        TextToSpeechComponent_1.prototype.SelectionMemory = function (obj) {
            return __awaiter(this, void 0, void 0, function () {
                var value;
                return __generator(this, function (_a) {
                    switch (_a.label) {
        ...
        TextToSpeechComponent_1.prototype.deleteMemory = function (obj) {
            return __awaiter(this, void 0, void 0, function () {
                var value, lista;
                return __generator(this, function (_a) {
                    switch (_a.label) {
        ...
        TextToSpeechComponent_1.prototype.saveLocalStorage = function (name) {
            this._utiliti.SetLocalStorage(name, JSON.stringify(this._listMemory));
        };
        TextToSpeechComponent_1.prototype.MemoryExist = function (name) {
        ...
        TextToSpeechComponent_1.prototype.Clean = function () {
            this._visibleLoading = true;
            this._extractedText = "";
            this.countSpeech = 0;
            this._visibleLoading = false;
        ...
        TextToSpeechComponent_1.prototype.alertSmg = function (msg) {
            this.startTimer(3000); // 5000 milisegundos (5 segundos)
            this._msg = msg;
            this._cdRef.detectChanges();
        };
        TextToSpeechComponent_1.prototype.startTimer = function (milliseconds) {
            var _this = this;
            this.stopTimer(this);
        ...
        TextToSpeechComponent_1.prototype.closeAlert = function () {
            this._msg = "";
            this._cdRef.detectChanges();
        };
        TextToSpeechComponent_1.prototype.stopTimer = function (id) {
            // Detén el temporizador si está en ejecución
            if (id !== null && id != undefined) {
                clearTimeout(id);
            }
        };
        return TextToSpeechComponent_1;
    }());
    __setFunctionName(_classThis, "TextToSpeechComponent");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        TextToSpeechComponent = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return TextToSpeechComponent = _classThis;
}();
exports.TextToSpeechComponent = TextToSpeechComponent;
//# sourceMappingURL=app.texttospeech-text-to-speech.js.map