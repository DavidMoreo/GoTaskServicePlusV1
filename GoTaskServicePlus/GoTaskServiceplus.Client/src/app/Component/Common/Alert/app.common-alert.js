...
var AlertComponent = function () {
    ...
    var _classThis;
    var AlertComponent = _classThis = /** @class */ (function () {
        function AlertComponent_1(_Service) {
            this._Service = _Service;
        }
        AlertComponent_1.prototype.ngOnInit = function () {
        };
        AlertComponent_1.prototype.CloseAlert = function () {
            return this._Service.CloseAlert();
        };
        AlertComponent_1.prototype.GetAlert = function () {
            return this._Service.GetMsg();
        };
        return AlertComponent_1;
    }());
...
//# sourceMappingURL=app.common-alert.js.map