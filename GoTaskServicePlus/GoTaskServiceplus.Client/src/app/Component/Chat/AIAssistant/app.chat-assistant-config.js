...
exports.ChatConfigAssistantComponent = void 0;
...
var ChatConfigAssistantComponent = function () {
    ...
    var _classThis;
    var ChatConfigAssistantComponent = _classThis = /** @class */ (function () {
        function ChatConfigAssistantComponent_1(configservice, http, ChatBotService) {
            this.intent = new ChatModel_1.IntentChat();
            this._configservice = configservice;
            this._http = http;
            this._chatBotIntentConfigService = ChatBotService;
        }
        ChatConfigAssistantComponent_1.prototype.ngOnInit = function () {
            this.GetAllIntent();
        };
        //Load
        ChatConfigAssistantComponent_1.prototype.GetAllIntent = function () {
            this._chatBotIntentConfigService.GetAllIntent(0);
        };
        ChatConfigAssistantComponent_1.prototype.Delete = function (id) {
            this._chatBotIntentConfigService.DeleteIntentById(id);
        };
        ChatConfigAssistantComponent_1.prototype.Edit = function (id) {
            var _this = this;
            this._chatBotIntentConfigService.GetIntentById(id).subscribe(function (e) {
                _this.intent = e.data;
            });
        };
        ChatConfigAssistantComponent_1.prototype.SaveAndUpdate = function () {
        ...
        //Changed
        ChatConfigAssistantComponent_1.prototype.ChangedTypeIntent = function (value) {
            this.intent.intent = value;
        };
        ChatConfigAssistantComponent_1.prototype.ChangedMsgIntent = function (value) {
            this.intent.question = value;
        };
        ChatConfigAssistantComponent_1.prototype.ChangedChatAfirmative = function (status) {
        };
        ChatConfigAssistantComponent_1.prototype.LoadTypeIntent = function () {
            var list = Array();
        ...
        ChatConfigAssistantComponent_1.prototype.Selection = function (id) {
            this._rowSeletion = id;
        };
        ChatConfigAssistantComponent_1.prototype.languageTraslate = function (value) {
            return value;
        };
        ChatConfigAssistantComponent_1.prototype.ValidateConcept = function () {
        };
        return ChatConfigAssistantComponent_1;
    }());
    __setFunctionName(_classThis, "ChatConfigAssistantComponent");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        ChatConfigAssistantComponent = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ChatConfigAssistantComponent = _classThis;
}();
exports.ChatConfigAssistantComponent = ChatConfigAssistantComponent;
//# sourceMappingURL=app.chat-assistant-config.js.map